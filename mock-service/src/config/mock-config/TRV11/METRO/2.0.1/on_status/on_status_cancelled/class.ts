...
import { onStatusCancelGenerator } from "./generator";

export class MockOnStatusCancelMetro201Class extends MockAction {
  ...
  name(): string {
    return "on_status_cancel_METRO_201";
  }
  get description(): string {
    return "Mock for on_status_cancel_METRO_201";
  }
