...
import { onCancelInitGenerator } from "./generator";

export class OnCancelInitMetro201Class extends MockAction {
  ...
  name(): string {
    return "on_cancel_init_METRO_201";
  }
  generator(existingPayload: any, sessionData: SessionData): Promise<any> {
    return onCancelInitGenerator(existingPayload, sessionData);
  }
  get description(): string {
    return "Mock for on_cancel_init_METRO_201";
  }
  async validate(
  targetPayload: any,
