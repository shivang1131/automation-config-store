...
import { onCancelHardGenerator } from "./generator";

export class OnCancelHardMetro201Class extends MockAction {
  ...
  name(): string {
    return "on_cancel_hard_METRO_201";
  }
  generator(existingPayload: any, sessionData: SessionData): Promise<any> {
    return onCancelHardGenerator(existingPayload, sessionData);
  }
  get description(): string {
    return "Mock for on_cancel_hard_METRO_201";
  }
  async validate(
  targetPayload: any,
